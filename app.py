import os
# os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = 'your-credential-files-here'
...
credentials = ServiceAccountCredentials.from_json_keyfile_name(
    'your-credential-files-here', scopes)

# credentials = GoogleCredentials.get_application_default()
client = storage.Client(project='your-google-app-here', credentials=credentials)
bucket = client.get_bucket('your-google-app-here')
